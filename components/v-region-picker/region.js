const citys = {
  ...
  "海南省": {
    "海口市": ["秀英区", "龙华区", "琼山区", "美兰区"],
    "三亚市": ["三亚市"],
    "省直辖县级行政区划": ["五指山市", "琼海市", "儋州市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县", "西沙群岛", "南沙群岛", "中沙群岛的岛礁及其海域"]
  },
  "重庆市": {
    "万州区": ["涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "綦江区", "大足区", "渝北区", "巴南区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区"],
    "市辖县": ["潼南县", "铜梁县", "荣昌县", "璧山县", "梁平县", "城口县", "丰都县", "垫江县", "武隆县", "忠县", "开县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县"]
  },
  "四川省": {
  ...
  "台湾省": {
    ...
    "新竹市": ["东区", "北区", "香山区"],
    "嘉义市": ["东区", "西区"],
    "县": ["台北县(板桥市)", "宜兰县(宜兰市)", "新竹县(竹北市)", "桃园县(桃园市)", "苗栗县(苗栗市)", "台中县(丰原市)", "彰化县(彰化市)", "南投县(南投市)", "嘉义县(太保市)", "云林县(斗六市)", "台南县(新营市)", "高雄县(凤山市)", "屏东县(屏东市)", "台东县(台东市)", "花莲县(花莲市)", "澎湖县(马公市)"]
  },
  "其它": {
    "亚洲": ["阿富汗", "巴林", "孟加拉国", "不丹", "文莱", "缅甸", "塞浦路斯", "印度", "印度尼西亚", "伊朗", "伊拉克", "日本", "约旦", "朝鲜", "科威特", "老挝", "马尔代夫", "黎巴嫩", "马来西亚", "以色列", "蒙古", "尼泊尔", "阿曼", "巴基斯坦", "巴勒斯坦", "菲律宾", "沙特阿拉伯", "新加坡", "斯里兰卡", "叙利亚", "泰国", "柬埔寨", "土耳其", "阿联酋", "越南", "也门", "韩国", "中国", "中国香港", "中国澳门", "中国台湾"],
    "非洲": ["阿尔及利亚", "安哥拉", "厄里特里亚", "法罗群鸟", "加那利群岛(西)(拉斯帕尔马斯)", "贝宁", "博茨瓦纳", "布基纳法索", "布隆迪", "喀麦隆", "加那利群岛(西)(圣克鲁斯)", "佛得角", "中非", "乍得", "科摩罗", "刚果", "吉布提", "埃及", "埃塞俄比亚", "赤道几内亚", "加蓬", "冈比亚", "加纳", "几内亚", "南非", "几内亚比绍", "科特迪瓦", "肯尼亚", "莱索托", "利比里亚", "利比亚", "马达加斯加", "马拉维", "马里", "毛里塔尼亚", "毛里求斯", "摩洛哥", "莫桑比克", "尼日尔", "尼日利亚", "留尼旺岛", "卢旺达", "塞内加尔", "塞舌尔", "塞拉利昂", "索马里", "苏丹", "斯威士兰", "坦桑尼亚", "圣赤勒拿", "多哥", "突尼斯", "乌干达", "扎伊尔", "赞比亚", "津巴布韦", "纳米比亚", "迪戈加西亚", "桑给巴尔", "马约特岛", "圣多美和普林西比"],
    "欧洲": ["阿尔巴尼亚", "安道尔", "奥地利", "比利时", "保加利亚", "捷克", "丹麦", "芬兰", "法国", "德国", "直布罗陀(英)", "希腊", "匈牙利", "冰岛", "爱尔兰", "意大利", "列支敦士登", "斯洛伐克", "卢森堡", "马耳他", "摩纳哥", "荷兰", "挪威", "波兰", "葡萄牙", "马其顿", "罗马尼亚", "南斯拉夫", "圣马力诺", "西班牙", "瑞典", "瑞士", "英国", "科罗地亚", "斯洛文尼亚", "梵蒂冈", "波斯尼亚和塞哥维那", "俄罗斯联邦", "亚美尼亚共和国", "白俄罗斯共和国", "格鲁吉亚共和国", "哈萨克斯坦共和国", "吉尔吉斯坦共和国", "乌兹别克斯坦共和国", "塔吉克斯坦共和国", "土库曼斯坦共和国", "乌克兰", "立陶宛", "拉脱维亚", "爱沙尼亚", "摩尔多瓦", "阿塞拜疆"],
    "美洲": ["安圭拉岛", "安提瓜和巴布达", "阿根廷", "阿鲁巴岛", "阿森松", "巴哈马", "巴巴多斯", "伯利兹", "百慕大群岛", "玻利维亚", "巴西", "加拿大", "开曼群岛", "智利", "哥伦比亚", "多米尼加联邦", "哥斯达黎加", "古巴", "多米尼加共和国", "厄瓜多尔", "萨尔瓦多", "法属圭亚那", "格林纳达", "危地马拉", "圭亚那", "海地", "洪都拉斯", "牙买加", "马提尼克(法)", "墨西哥", "蒙特塞拉特岛", "荷属安的列斯群岛", "尼加拉瓜", "巴拿马", "巴拉圭", "秘鲁", "波多黎哥", "圣皮埃尔岛密克隆岛(法)", "圣克里斯托弗和尼维斯", "圣卢西亚", "福克兰群岛", "维尔京群岛(英)", "圣文森特岛(英)", "维尔京群岛(美)", "苏里南", "特立尼达和多巴哥", "乌拉圭", "美国", "委内瑞拉", "格陵兰岛", "特克斯和凯科斯群岛", "瓜多罗普"],
    "大洋洲": ["澳大利亚", "科克群岛", "斐济", "法属波里尼西亚、塔希提", "瓦努阿图", "关岛", "基里巴斯", "马里亚纳群岛", "中途岛", "瑙鲁", "新咯里多尼亚群岛", "新西兰", "巴布亚新几内亚", "东萨摩亚", "西萨摩亚", "所罗门群岛", "汤加", "对诞岛", "威克岛", "科科斯岛", "夏威夷", "诺福克岛", "帕劳", "纽埃岛", "图瓦卢", "托克鲁", "密克罗尼西亚", "马绍尔群岛", "瓦里斯加富士那群岛"]
  }
}
